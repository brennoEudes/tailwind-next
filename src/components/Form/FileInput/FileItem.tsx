...
const fileItem = tv({
  // base: 'group flex items-start gap-4 rounded-lg border border-zinc-200 p-4', (substituído por slots API)

  // SLOT API: permite ao fileItem estilizar vários elementos simultaneamente
  slots: {
    container:
  ...
  variants: {
    // state: { (substituído por slots API)
    //   progress: '',
